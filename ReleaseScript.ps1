...
{
@"
# Release notes go here. Do not deviate from this template; points can be added/removed as long as they adhere to the style.
...
$releaseNotes = Get-Content $releaseNotesFile | Where-Object { $_ -and ($_ -notmatch '^\s*#') }
